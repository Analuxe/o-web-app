  ...
  Future<void> _seedDummyData() async {
    ...
    final dummyPosts = [
      HubPost(
        ...
        subtitle: 'Our new "Profile Visitors" feature is live. Check your profile settings to see who has been viewing you recently.',
      ...
      HubPost(
        id: '',
        title: 'Enhanced Safety & Verification',
        subtitle: 'We\'ve upgraded our AI-powered ID verification and community vouching systems to keep the community elite.',
      ...
      HubPost(
        id: '',
        title: 'O Premium Plus',
        subtitle: 'Priority placement in discovery and unlimited profile visitor history.',
        tag: 'PREMIUM',
